...
The **Museum With No Frontiers — Arms and Armoury** gallery, built from the published
dataset `@museumwnf/arms-armoury-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/arms-armoury-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/arms-armoury/> through the reusable workflows in
