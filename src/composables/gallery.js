...
// `useGalleryData.js` used to be byte-identical local copies of what arms-armoury
...
// legacy project key, no UUID — arms-armoury shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (arms-armoury-data 1.0.11+), an outside
