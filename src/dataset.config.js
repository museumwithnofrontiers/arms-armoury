...
export default {
  ...
  siteName: manifest.site?.names?.en ?? 'Arms and Armoury',
  ...
  // one entry for every project id `npm pack @museumwnf/arms-armoury-data`
  // carries in `manifest.projects` (checked 2026-09-19, arms-armoury-data 1.0.9).
  ...
  site: { origin: 'https://museumwithnofrontiers.github.io/arms-armoury' },
