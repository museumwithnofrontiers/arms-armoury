...
export default {
  ...
  home: {
    title: 'armsArmoury.identity.title',
    intro: 'armsArmoury.home.intro',
    cards: [
      {
        title: 'armsArmoury.nav.catalogue',
        description: 'armsArmoury.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'armsArmoury.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'armsArmoury.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'armsArmoury.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'armsArmoury.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'armsArmoury.partnerObjects.emptyPartner',
  //         emptyInstitution: 'armsArmoury.partnerObjects.emptyInstitution',
  //         institutionSummary: 'armsArmoury.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'armsArmoury.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'armsArmoury.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
